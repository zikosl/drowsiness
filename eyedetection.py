...
eye_cascade_left = cv2.CascadeClassifier('Haar/haarcascade_lefteye_2splits.xml')
eye_cascade_right = cv2.CascadeClassifier('Haar/haarcascade_righteye_2splits.xml')
def help_message():
